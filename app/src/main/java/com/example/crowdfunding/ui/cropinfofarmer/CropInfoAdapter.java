...
public class CropInfoAdapter extends RecyclerView.Adapter<CropInfoAdapter.MyViewHolder> {
    Context c;
    ...
    public CropInfoAdapter(Context c, int image[], String sname[], String sdesc[]) {
        this.c=c;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cropinfo_row_farmer,parent,false);
