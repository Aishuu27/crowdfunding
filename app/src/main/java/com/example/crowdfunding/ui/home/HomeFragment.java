...
public class HomeFragment extends Fragment {
    ...
    "Paramparagat Krishi Vikas Yojana (PKVY)","Pradhan Mantri Fasal Bima Yojana (PMFBY)","Gramin Bhandaran Yojna","Livestock insurance Scheme"
    ,"Scheme on Fisheries Training and Extension","National Scheme on Welfare of Fishermen","Micro Irrigation Fund (MIF)"};*/
