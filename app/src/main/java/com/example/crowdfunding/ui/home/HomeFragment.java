...
public class HomeFragment extends Fragment {
    ...
    private String sname[]=getActivity().getResources().getStringArray(R.array.schemes);

    private String sdesc[]=getActivity().getResources().getStringArray(R.array.schemes_description);
